<div class="container">
    ...
    <p class='margin-bottom-15'>" . $row['description'] . "</p>";
            ...
            <form action="./server/requests.php" method="post">
                ...
                <textarea name="answer" class="form-control margin-bottom-15" placeholder="Your answer..." required></textarea>
                <button class="btn btn-primary" name="ans">Write your answer</button>
            </form>
        </div>
        <div class="col-4">
